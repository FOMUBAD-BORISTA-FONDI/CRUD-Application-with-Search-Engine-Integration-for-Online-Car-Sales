...
class Pub{
        public function fetch_all(){
            ...
            $squery = $connexion-> prepare("SELECT * FROM Voiture WHERE id_voiture = '$id' ");
            $squery->execute();
...
<?php foreach ($pub as $pb) { ?>
    ...
    <div class="product-info grid">
        ...
        <div class="price">
          <p class="bold-700 fs-poppins fs-300">Modele : <?php echo $pb['modele'] ;?></p>
        </div>
        <div class="price">
        ...
        <button class="product-btn large-btn bg-green text-white fs-poppins fs-50"  ><a href="index.php">Retour</a></button>
