...
.col-9{
 ...
 <!-- partir permettant de faire la recherche par filtre -->
    ...
    <main class="hero-section">
      ...
      <div class="hero-inner flex">
        <div>
          <button class="large-btn bg-red text-white fs-poppins fs-50"><a href="shop.html">Connectez Vous !</a>
          </button>
        </div>
        <div class="hero-info">
          <h4 class="fs-montserrat">Description</h4>
          <p class="fs-montserrat">
            Bienvenu dans notre site de presentation de voiture pour une vente et annonce.
          </p>
        </div>
      </div>
    </main>
